                                ...
                                <div class="col-md-5 text-center bg-card-gradient">
                                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                                        ...
                                        <div class="z-index-1 position-relative"><a
                                                ...
                                                href="/">E-KLINIK</a>
                                            <p class="opacity-75 text-white">Masukkan email jika anda melupakan password
                                                anda, anda akan mendapatkan email untuk reset password!</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-sm-8 col-md">
                                                ...
                                                </form><a class="fs--1 text-600" href="#!">I can't recover my account
                                                    using this page<span class="d-inline-block ms-1">&rarr;</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
